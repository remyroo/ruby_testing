...
describe FindNumber do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:number_guessing) { double('random_number', value: 4) }
      subject(:game_end) { described_class.new(4, 4, number_guessing, 4) }
    ...
    context 'when guess and random_number are not equal' do
      let(:number_guessing) { double('random_number', value: 4) }
      subject(:game_continue) { described_class.new(3, 3, number_guessing, 3) }
